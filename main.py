...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == 'single_report':
        ...
        if target_user:
            ...
            # Deduct credits if user is not free or owner
            if account_type != 'FREE' and str(user_id) != OWNER_ID:
    ...
    # Owner Panel: Statistics
    elif data == 'owner_stats' and str(user_id) == OWNER_ID:
        await show_statistics(update, context)

    # Owner Panel: Broadcast
    elif data == 'owner_broadcast' and str(user_id) == OWNER_ID:
    ...
    elif data == 'owner_users' and str(user_id) == OWNER_ID:
        await manage_users(update, context)

    # Owner Panel: Key Management
    elif data == 'owner_keys' and str(user_id) == OWNER_ID:
